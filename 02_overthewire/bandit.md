...
```Bash
bandit27@bandit:~$ mkdir /tmp/shunabandit27
bandit27@bandit:~$ cd /tmp/shunabandit27
bandit27@bandit:/tmp/shunabandit27$ git clome  ssh://bandit27-git@localhost/home/bandit27-git/repo
fatal: Invalid gitfile format: .git
bandit27@bandit:/tmp/shunabandit27$ git clone ssh://bandit27-git@localhost/home/bandit27-git/repo
Cloning into 'repo'...
...
bandit27@bandit:/tmp/shunabandit27$ ls
repo
bandit27@bandit:/tmp/shunabandit27$ ls repo/
README
bandit27@bandit:/tmp/shunabandit27$ more repo/README 
The password to the next level is: 0ef186ac70e04ea33b4c1853d2526fa2
bandit27@bandit:/tmp/shunabandit27$ 
...
```Bash
bandit28@bandit:~$ ls
bandit28@bandit:~$ mkdir /tmp/shuna_bandit28
bandit28@bandit:~$ cd /tmp/shuna_bandit28
bandit28@bandit:/tmp/shuna_bandit28$ git clone ssh://bandit28-git@localhost/home/bandit28-git/repo
Cloning into 'repo'...
...
bandit28@bandit:/tmp/shuna_bandit28$ ls
repo
bandit28@bandit:/tmp/shuna_bandit28$ ls repo/
README.md
bandit28@bandit:/tmp/shuna_bandit28$ more repo/README.md 
# Bandit Notes
...
bandit28@bandit:/tmp/shuna_bandit28/repo$ git log -p
